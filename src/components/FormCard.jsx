export default function FormCard({ addOperation, selectionRef, descriptionRef, importRef }) {
  ...
  return (
    <form onSubmit={addOperation} className="my-10">
      ...
      <div className="bg-slate-100 p-6 rounded-3xl flex gap-4 items-end">
        <div>
          <label className="block text-sm font-medium text-slate-700 mb-1">Seleziona</label>
